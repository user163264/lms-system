#!/usr/bin/env python3
"""
Script Name: create_migration.py
Description: Creates database migration scripts for the LMS system

Usage:
    python scripts/database/setup/create_migration.py [options]

Options:
    --message TEXT    Migration message
    --auto            Auto-generate migration based on model changes
