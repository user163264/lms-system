...
Description: Sets up the LMS database, creates tables, and initializes data

Usage:
    python scripts/database/setup/setup_database.py [--force] [--no-data]

Options:
    --force         Force recreate all tables even if they exist
    --no-data       Do not load initial data

Dependencies:
    - psycopg2

Output:
    Database setup status messages
