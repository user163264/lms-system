...
export default function DirectShowcasePage() {
  const [isClient, setIsClient] = useState(false);
  
  useEffect(() => {
    console.log('DirectShowcasePage mounted on client');
    setIsClient(true);
  }, []);
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-6">Direct Component Showcase</h1>
